...
public class LayerState3 {
	...
	public LayerState3(int perimeter, long horiNumber) {
	...
	public LayerState3 hardCopy() {
		LayerState3 copy = new LayerState3();
	...
	public boolean equals(LayerState3 other) {
	...
	public static void main(String args[]) {
		...
		for(int i=0; i<numToCheck; i++) {
			...
			LayerState3 cur = new LayerState3(perimeter, i);
		...
		LayerState3 layer0 = new LayerState3(perimeter, 0);
		...
		for(int i=0; i<numToCheck; i++) {
			...
			if(cur.isValid()) {
				...
				LayerState3 layerAbove = addLayerStateOnTopOfLayerState(layer0, cur, 0);
	...
	public static LayerState3 addLayerStateOnTopOfLayerState(LayerState3 bottom, LayerState3 top, int displacementX) {
		...
		LayerState3 topRet = top.hardCopy();
