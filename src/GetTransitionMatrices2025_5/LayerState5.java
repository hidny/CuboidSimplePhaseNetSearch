...
public class LayerState5 {
	...
	public LayerState5(int perimeter, long horiNumber) {
	...
	public LayerState5 hardCopy() {
		LayerState5 copy = new LayerState5();
	...
	public boolean equals(LayerState5 other) {
	...
	public static void main(String args[]) {
		...
		for(int i=0; i<numToCheck; i++) {
			...
			LayerState5 cur = new LayerState5(perimeter, i);
		...
		LayerState5 layer0 = new LayerState5(perimeter, 0);
		...
		for(int i=0; i<numToCheck; i++) {
			...
			if(cur.isValid()) {
				...
				LayerState5 layerAbove = addLayerStateOnTopOfLayerState(layer0, cur, 0);
	...
	public static LayerState5 addLayerStateOnTopOfLayerState(LayerState5 bottom, LayerState5 top, int displacementX) {
		...
		LayerState5 topRet = top.hardCopy();
