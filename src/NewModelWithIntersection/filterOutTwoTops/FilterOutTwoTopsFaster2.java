...
public class FilterOutTwoTopsFaster2 {
	...
	public FilterOutTwoTopsFaster2(CoordWithRotationAndIndex[][] allNeighbours) {
	...
	public boolean isPossibleAfterBasicDeduction(long curState[]) {
		...
		if(topIndex == TOP_INDEX_UNKNOWN) {
			...
			for(int i=0; i<this.numCells; i++) {
				if(isTopPossibleAfterBasicDeduction(curState, i)) {
					return true;
				}
			}
			return false;
