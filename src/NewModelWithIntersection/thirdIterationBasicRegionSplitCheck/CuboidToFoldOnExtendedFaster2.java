...
public class CuboidToFoldOnExtendedFaster2 extends CuboidToFoldOn {

	
	// ######################
	

	public CuboidToFoldOnExtendedFaster2(int a, int b, int c) {
		super(a, b, c);
	...
	public boolean unoccupiedRegionSplit() {
	...
	public boolean isNewLayerValidSimpleFast(int sideBump) {
		...
		return ((curState[0] & tmp[0]) | (curState[1] & tmp[1]) | (curState[2] & tmp[2])) == 0L  && ! unoccupiedRegionSplit();
