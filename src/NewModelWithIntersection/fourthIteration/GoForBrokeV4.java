...
public class GoForBrokeV4 {
	...
	public static void goForBroke(int cuboids[][]) {
		...
		ReallySimpleIntersectFinder3.reallySimpleSearch(cuboids[0][0], cuboids[0][1], cuboids[0][2]);
		...
		for(int i=1; i<cuboids.length; i++) {
			...
			ReallySimpleIntersectFinder3.reallySimpleSearch(cuboids[i][0], cuboids[i][1], cuboids[i][2]);
			//ReallySimpleIntersectFinder.reallySimpleSearch(2, 1, 1);
