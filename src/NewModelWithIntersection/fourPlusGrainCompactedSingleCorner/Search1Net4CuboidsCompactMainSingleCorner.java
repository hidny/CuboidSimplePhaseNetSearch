...
public class Search1Net4CuboidsCompactMainSingleCorner {

	public static void main(String[] args) {

		System.out.println("Trying compact version of the search algo:");
		search();
	...
	public static final int COMPACT_HEIGHT = 2;
