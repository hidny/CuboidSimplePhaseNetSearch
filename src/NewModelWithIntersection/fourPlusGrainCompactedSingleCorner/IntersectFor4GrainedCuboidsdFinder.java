package NewModelWithIntersection.fourPlusGrainCompactedSingleCorner;
...
public class IntersectFor4GrainedCuboidsdFinder {
	...
	public static void findIntersectFor4GrainedCuboidsFinder(int cuboid1[], int cuboid2[], int cuboid3[], int cuboid4[]) {
		...
		CuboidToFoldOnGrainedWithOtherGrains cuboidToBuild = new CuboidToFoldOnGrainedWithOtherGrains(cuboid1, cuboid2, cuboid3, cuboid4);
		...
		for(int i=0; i<startingPointsAndRotationsToCheck.size(); i++) {
			...
			if(otherCuboidStartIndex != 0 || otherCuboidStartRotation == 1) {
				//Only focus on the corner to make it faster.
				continue;
			}
	...
	public static int getNumLayers(CuboidToFoldOnGrainedWithOtherGrains cuboidToBuild) {
		return (cuboidToBuild.getNumCellsToFill() - 2) / 4;
	}
	
	public static long findReallySimpleSolutionsRecursion(Nx1x1CuboidToFold reference, CuboidToFoldOnGrainedWithOtherGrains cuboidToBuild) {
	...
	public static long findReallySimpleSolutionsRecursion(Nx1x1CuboidToFold reference, CuboidToFoldOnGrainedWithOtherGrains cuboidToBuild, int layerIndex, int numLayers) {
