...
public class CuboidToFoldOnGrainedWithOtherGrainsFraction implements CuboidToFoldOnInterface {

	private CoordWithRotationAndIndex[][] neighbours;

	public int dimensions[] = new int[3];

	public CuboidToFoldOnGrainedWithOtherGrainsFraction(int cuboid1[], int cuboid2[], int cuboid3[], int cuboid4[], int k) {
		this(cuboid1, cuboid2, cuboid3, cuboid4, k, true);
	}
	...
	public void printCurrentStateOnOtherCuboidsFlatMap() {
		...
		CuboidToFoldOnGrainedWithOtherGrainsFraction toPrint = new CuboidToFoldOnGrainedWithOtherGrainsFraction(new int[] {1, 1, 1},
				this.cuboid2, this.cuboid3, this.cuboid4, 2, false);
