...
public class LayerState6 {
	...
	public LayerState6(int perimeter, long horiNumber) {
		...
		//Rule out states that don't return:
		if(quotientP >= 1) {
			valid =  false;
		}
		
		//Try ruling out states where there's a hole bigger than perimeter:
	...
	public LayerState6 hardCopy() {
		LayerState6 copy = new LayerState6();
	...
	public boolean equals(LayerState6 other) {
	...
	public static void main(String args[]) {
		...
		for(int i=0; i<numToCheck; i++) {
			...
			LayerState6 cur = new LayerState6(perimeter, i);
		...
		LayerState6 layer0 = new LayerState6(perimeter, 0);
		...
		for(int i=0; i<numToCheck; i++) {
			...
			if(cur.isValid()) {
				...
				LayerState6 layerAbove = addLayerStateOnTopOfLayerState(layer0, cur, 0);
	...
	public static LayerState6 addLayerStateOnTopOfLayerState(LayerState6 bottom, LayerState6 top, int displacementX) {
		...
		LayerState6 topRet = top.hardCopy();
