...
public class LayerState7 {
	...
	public LayerState7 hardCopy() {
		LayerState7 copy = new LayerState7();
	...
	public boolean equals(LayerState7 other) {
	...
	public static void main(String args[]) {
		...
		for(int i=0; i<numToCheck; i++) {
			...
			LayerState7 cur = new LayerState7(perimeter, i);
		...
		LayerState7 layer0 = new LayerState7(perimeter, 0);
		...
		for(int i=0; i<numToCheck; i++) {
			...
			if(cur.isValid()) {
				...
				LayerState7 layerAbove = addLayerStateOnTopOfLayerState(layer0, cur, 0);
	...
	public static LayerState7 addLayerStateOnTopOfLayerState(LayerState7 bottom, LayerState7 top, int displacementX) {
		...
		LayerState7 topRet = top.hardCopy();
