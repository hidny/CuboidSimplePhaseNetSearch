...
public class ReallySimpleIntersectFinder7 {
...
12 x 3 x 1: 102
	...
	public static void reallySimpleSearch(int a, int b, int c) {
		...
		CuboidToFoldOnExtendedSimplePhase7 cuboidToBuild = new CuboidToFoldOnExtendedSimplePhase7(a, b, c);
		...
		for(int i=0; i<startingPointsAndRotationsToCheck.size(); i++) {
			...
			cuboidToBuild = new CuboidToFoldOnExtendedSimplePhase7(a, b, c);
	...
	public static int getNumLayers(CuboidToFoldOnExtendedSimplePhase7 cuboidToBuild) {
		
		return (cuboidToBuild.getNumCellsToFill() - 2) / 4;
	}
	
	public static long findReallySimpleSolutionsRecursion(CuboidToFoldOnExtendedSimplePhase7 cuboidToBuild) {
	...
	public static long findReallySimpleSolutionsRecursionFirstLayer(CuboidToFoldOnExtendedSimplePhase7 cuboidToBuild, int numLayers) {
		long ret = 0;
		...
		for(int sideBump=FIRST_LEGAL_SIDE_BUMP_Nx1x1; sideBump <FIRST_LEGAL_SIDE_BUMP_Nx1x1 + WIDTH_Nx1x1; sideBump++) {
			...
			if(CuboidToFoldOnExtendedSimplePhase7.LEVEL_OPTIONS[0][0 - (sideBump - 6)] != 1) {
	...
	public static long findReallySimpleSolutionsRecursion(CuboidToFoldOnExtendedSimplePhase7 cuboidToBuild, int curLayerIndex, int numLayers, int prevLayerStateIndex,
			boolean debugNope) {
