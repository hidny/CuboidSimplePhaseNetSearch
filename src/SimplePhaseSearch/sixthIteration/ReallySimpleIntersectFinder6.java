package SimplePhaseSearch.sixthIteration;
...
12 x 3 x 1: 102
	...
	public static void reallySimpleSearch(int a, int b, int c) {
		...
		CuboidToFoldOnExtendedSimplePhase6 cuboidToBuild = new CuboidToFoldOnExtendedSimplePhase6(a, b, c);
		...
		for(int i=0; i<startingPointsAndRotationsToCheck.size(); i++) {
			...
			cuboidToBuild = new CuboidToFoldOnExtendedSimplePhase6(a, b, c);
	...
	public static int getNumLayers(CuboidToFoldOnExtendedSimplePhase6 cuboidToBuild) {
		
		return (cuboidToBuild.getNumCellsToFill() - 2) / 4;
	}
	
	public static long findReallySimpleSolutionsRecursion(CuboidToFoldOnExtendedSimplePhase6 cuboidToBuild) {
	...
	public static long findReallySimpleSolutionsRecursionFirstLayer(CuboidToFoldOnExtendedSimplePhase6 cuboidToBuild, int numLayers) {
		long ret = 0;
		...
		for(int sideBump=FIRST_LEGAL_SIDE_BUMP_Nx1x1; sideBump <FIRST_LEGAL_SIDE_BUMP_Nx1x1 + WIDTH_Nx1x1; sideBump++) {
			...
			if(CuboidToFoldOnExtendedSimplePhase6.LEVEL_OPTIONS[0][0 - (sideBump - 6)] != 1) {
