...
public class RegionSplitLogicSimple3 {
	...
	public void initNumCellsAbovePerLayer() {
		...
		for(int i=0; i<numCellsAbovePerLayerMid.length; i++) {
			...
			for(int j=0; j<CuboidToFoldOnExtendedSimplePhase6.CELLS_TO_ADD_BY_STATE_GOING_UP_MIDDLE[i].length; j++) {
				
				if(! foundFirst && CuboidToFoldOnExtendedSimplePhase6.CELLS_TO_ADD_BY_STATE_GOING_UP_MIDDLE[i][j] == 1) {
					firstIndex = j;
					foundFirst = true;
		...
		for(int i=0; i<numCellsAbovePerLayerSide.length; i++) {
			...
			for(int j=0; j<CuboidToFoldOnExtendedSimplePhase6.CELLS_TO_ADD_BY_STATE_GOING_UP_ON_SIDE[i].length; j++) {
				
				if(! foundFirst && CuboidToFoldOnExtendedSimplePhase6.CELLS_TO_ADD_BY_STATE_GOING_UP_ON_SIDE[i][j] == 1) {
					firstIndex = j;
					foundFirst = true;
